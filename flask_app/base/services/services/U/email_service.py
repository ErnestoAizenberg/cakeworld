# flask_app/services/email_service.py
...
class EmailService:
    ...
    def send_verification_email(self, user_dto):
        ...
        verification_link = url_for(
            "verify", token=user_dto.verification_token, _external=True
        )
    ...
    def send_reset_password_email(self, user_dto):
        ...
        reset_link = url_for(
            "confirm_reset_password", token=user_dto.verification_token, _external=True
        )
        html_content = render_template(
