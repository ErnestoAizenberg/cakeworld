...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const openModalButton = document.getElementById('openJoinModalButton');
  const closeModalButton = document.querySelector('.close');
  const joinChatForm = document.getElementById('joinChatForm');
  const closeModalSuccessButton = document.getElementById('closeModal');
  const retryRequestButton = document.getElementById('retryRequest');

  if (!modal || !openModalButton || !closeModalButton || !joinChatForm || !closeModalSuccessButton || !retryRequestButton) {
  ...
  joinChatForm.onsubmit = async (event) => {
  ...
  closeModalSuccessButton.onclick = closeModal;

  retryRequestButton.onclick = () => {
    closeModal();
    openModal();
  };
});